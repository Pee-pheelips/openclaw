...
RUN --mount=type=cache,id=8b8066ec-58b0-4e4e-8ca3-ac30beca29b4-,target=/root/.local/share/pnpm/store,sharing=locked \
...
RUN --mount=type=cache,id=8b8066ec-58b0-4e4e-8ca3-ac30beca29b4-,target=/var/cache/apt,sharing=locked \
    --mount=type=cache,id=8b8066ec-58b0-4e4e-8ca3-ac30beca29b4-,target=/var/lib/apt,sharing=locked \
    apt-get update && \
